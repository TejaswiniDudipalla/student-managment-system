...
namespace Student_Managment_system.Controllers
{
    ...
    {
        private student_dbEntities1 db = new student_dbEntities1();
        ...
        public ActionResult Create([Bind(Include = "id,first_name,last_name,nic,course_id,batch_id,telephone_number")] Registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,first_name,last_name,nic,course_id,batch_id,telephone_number")] Registration registration)
        {
            if (ModelState.IsValid)
            {
